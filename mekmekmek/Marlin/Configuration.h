...
#define STRING_CONFIG_H_AUTHOR "(Mekmekmek,Y3d_Roststock_diy+reprappro hotend_janscomment)" // Who made the changes.
...
#define DELTA
// absolute höhevon heatbed to hotend MAX build höhe
#define MANUAL_Z_HOME_POS 446 
...
#define DELTA_DIAGONAL_ROD 250.0 // mm abstandder arme (von schraube zu schraube 

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 185.0 // mm abstand vonallen3 achsen zurmitte

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 22.5//33.0 // mm abstand achsenlagerz zum armen-gelenkOben

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 33//22.5 // mm von armen zur trägerplatee radius träger

// Horizontal distance bridged by diagonal push rods when effector is centered.
#define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
#define DELTA_PRINTABLE_RADIUS 150.0 //radius bauraum
...
//is true weil extruder gear spiegelverkehrt wegen  direct drive jan
...
#define MANUAL_Z_HOME_POS 446  // jan eprom setting max höhe For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,80,100}//{XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 170}
